...
Given the received encoded sequence \ref{c1} and a candidate codeword set {11110,110,01}. The codeword set needs to be listed in order by length.\\[6pt]
%\begin{figure}[h!]
%\begin{center}
\makebox[\linewidth][c]{Received encoded sequence: 0101010100100101000001000010101010010000011000001}\\
%\end{center}
%\makebox[\linewidth][c]{Received encoded sequence}\\%\label{c1}
%\end{figure}

The codeword 11110 doesn't appear in the sequence \ref{c1}, so we have to search for the codeword 110.\\[6pt]
%\begin{figure}[h!]
%\begin{center}
\makebox[\linewidth][c]{01010101001001010000010000101010100100000{\bf 110}00001}\\
%\end{center}
\makebox[\linewidth][c]{Searching for 110 in sequence }\\%\label{c2}
%\end{figure}
